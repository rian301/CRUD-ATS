...
namespace WebMongoDB.Models
{
    public class ContextoMongodb
    {
        ...
        public IMongoCollection<Candidato> Candidato
        {
            get
            {
                return _database.GetCollection<Candidato>("Candidato");
            }
        }

        public IMongoCollection<Cargo> Cargo
        {
            get
            {
                return _database.GetCollection<Cargo>("Cargo");
            }
        }
    }
}
